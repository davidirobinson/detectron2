...
def preprocess_fn(path):
    ...
    # TODO(drobinson): Apparenty compiled model expects a batch dimension?
...
def main():
    ...
    ap.add_argument('-m', '--model', type=str, default='GeneralizedRCNN_zcu104.xmodel',
                    help='Path of xmodel. Default is GeneralizedRCNN_zcu104.xmodel')
